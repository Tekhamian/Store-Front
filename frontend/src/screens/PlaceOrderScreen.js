...
const PlaceOrderScreen = ({history}) => {
    ...
    // Calculate shipping price - can be tailored to more accurate specs later
    cart.shippingPrice = addDecimals(cart.itemsPrice > 1000 ? 0 : 100)

    // Calculate tax price - set to 15%
                ...
                <Col md={8}>
                    <ListGroup variant='flush'>
                        ...
                        <ListGroup.Item>
                            <h2>Items Ordered </h2>
                                {/* <strong>Items: </strong> */}
                                {cart.cartItems.length === 0 ? <Message>Sorry your cart is empty</Message>
                                :(
                                    <ListGroup variant='flush'>
                ...
                <Col md={4}>
                    <Card>
                        <ListGroup variant='flush'>
                            ...
                            <ListGroup.Item>
                                <Button color='black' type='button' className='btn-block' disabled={cart.cartItems === 0}
